...
# EncoderTool [![Badge Arduino]][Arduino]  [![Badge PlatformIO]][PlatformIO] [![Badge License]][License]
...
- Directly conneced encoders

- Interupt based or polled readout

- Multiplexed Encoders using

    - [74HC165 (Shift Register)][MPLEX74165]
